...
class DatasetCatalog(object):
    ...
    DATASETS = {
        "coco_jenga_train": {
            "img_dir": "coco_jenga/coco_train",
            "ann_file": "coco_jenga/coco_train/via_project_train_coco.json"
        },

        "coco_jenga_val": {
            "img_dir": "coco_jenga/coco_val",
            "ann_file": "coco_jenga/coco_val/via_project_val_coco.json"
        },
        "coco_2017_train": {
